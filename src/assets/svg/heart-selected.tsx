...
export const HeartSelected = (props) => (
  <Svg
    ...
    {...props}
  >
    <G filter="url(#filter0_b_1223_6225)" clipPath="url(#clip0_1223_6225)">
      <G filter="url(#filter1_b_1223_6225)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        <Path
          ...
          stroke="url(#paint0_linear_1223_6225)"
          strokeLinecap="round"
        />
      </G>
      <G filter="url(#filter2_d_1223_6225)">
        <Path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M17.244 5.3a.75.75 0 00-.533 1.401c.36.137.737.37 1.116.745.481.477.786 1 .956 1.552a.75.75 0 001.434-.442 5.194 5.194 0 00-1.334-2.176 4.695 4.695 0 00-1.639-1.08z"
          fill="url(#paint1_linear_1223_6225)"
        />
      </G>
    </G>
    <Defs>
      <LinearGradient
        id="paint0_linear_1223_6225"
        x1={2.5}
        y1={3}
        x2={20.4115}
        y2={22.8815}
