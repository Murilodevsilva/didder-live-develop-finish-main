...
export const MessageLogin = (props) => (
  ...
  >
    <Path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8.833 10.098a2.281 2.281 0 01-1.42-.497L4.047 6.889a.563.563 0 01.706-.876l3.361 2.709a1.158 1.158 0 001.442-.003l3.327-2.705a.562.562 0 11.71.873l-3.332 2.71a2.294 2.294 0 01-1.43.501z"
      fill="#fff"
    />
    <Mask
      id="a"
